### author: Soonchan Park (parksc@etri.re.kr)
### version: 2024.12.05.
### We refer the code from CP-VTON, VTION-HD, and HR-VITON.
...
class FTB_dataset(data.Dataset):
    """
    Dataset class for virtual try-on that handles both top and bottom garments.
    Processes model images, clothing items, and their corresponding segmentation masks.
    """
    ...
    def __init__(self, opt, is_train=True):
        ...
        print("***** Fashion-TB Initialized. train=",self.is_train, "FTB_dataset.py")
        ...
        print('***** TOTAL NUMBER OF DATA:', len(self.ann_list))
    ...
    def __getitem__(self, index):
        """
        Returns a data sample containing:
        - Model image and its parsing
        - Model's Pose keypoints        
        - Top garment image and its parsing
        - Bottom garment image and its parsing (if exists)        
        """
        ...
        # Return a dictionary containing all necessary information for try-on
        result = {
